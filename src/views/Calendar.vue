        ...
        <div id="event-modal" class="modal hidden">
            <div class="modal-content">
                ...
                <label>
                    强调色：
                    <div id="color-picker">
                        <button type="button" class="color-btn" data-color="#f87171"
                            style="background:#f87171"></button>
                        <button type="button" class="color-btn" data-color="#60a5fa"
                            style="background:#60a5fa"></button>
                        <button type="button" class="color-btn" data-color="#34d399"
...
export default {
    ...
    mounted() {
        ...
        function openEventModal(hour) {
            ...
            document.querySelectorAll('.color-btn, #evt-color')
      ...
      `;
        ...
        function createNote(text = '双击编辑便签内容') {
            ...
            noteEl.addEventListener('dragleave', () => noteEl.classList.remove('drag-over'));
